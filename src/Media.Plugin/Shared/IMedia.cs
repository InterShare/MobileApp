...
namespace Plugin.Media.Abstractions
{
    ...
    public interface IMedia
    {
		...
		/// </summary>
		/// <returns>Media file or null if canceled</returns>
		Task<List<MediaFile>> PickPhotoOrVideoAsync(PickMediaOptions options = null, MultiPickerOptions pickerOptions = null, CancellationToken token = default(CancellationToken));

...
namespace Plugin.Media
{
    public class CheckMarkView : UIView
    {
        ...
        void DrawRectChecked(CGRect rect)
        {
            ...
            UIColor checkmarkBlue2 = UIColor.FromRGBA(0.078f, 0.435f, 0.875f, 1f);

            // Shadow Declarations
            UIColor shadow2 = UIColor.Brown;
            ...
            // CheckedOval Drawing
            UIBezierPath checkedOvalPath = UIBezierPath.FromOval(new CGRect(group.GetMinX() + Math.Floor(group.Width * 0.00000 + 0.5), group.GetMinY() + Math.Floor(group.Height * 0.00000 + 0.5), Math.Floor(group.Width * 1.00000 + 0.5) - Math.Floor(group.Width * 0.00000 + 0.5), Math.Floor(group.Height * 1.00000 + 0.5) - Math.Floor(group.Height * 0.00000f + 0.5f)));
            context.SaveState();
        ...
        void DrawRectGrayedOut(CGRect rect)
        {
            ...
            UIColor grayTranslucent = UIColor.FromRGBA(1, 1, 1, 0.6f);

            // Shadow Declarations
            UIColor shadow2 = UIColor.Black;
            var shadow2Offset = new CGSize(0.1, -0.1);
            nfloat shadow2BlurRadius = 2.5f;
            ...
            UIBezierPath uncheckedOvalPath = UIBezierPath.FromOval(new CGRect(group.GetMinX() + Math.Floor(group.Width * 0.00000 + 0.5), group.GetMinY() + Math.Floor(group.Height * 0.00000 + 0.5), Math.Floor(group.Width * 1.00000 + 0.5) - Math.Floor(group.Width * 0.00000 + 0.5), Math.Floor(group.Height * 1.00000 + 0.5) - Math.Floor(group.Height * 0.00000 + 0.5)));
            context.SaveState();
            context.SetShadow(shadow2Offset, shadow2BlurRadius, shadow2.CGColor);
        ...
        void DrawRectOpenCircle(CGRect rect)
        {
            ...
            // EmptyOval Drawing
            UIBezierPath emptyOvalPath = UIBezierPath.FromOval(new CGRect(group.GetMinX() + Math.Floor(group.Width * 0.00000 + 0.5), group.GetMinY() + Math.Floor(group.Height * 0.00000 + 0.5), Math.Floor(group.Width * 1.00000 + 0.5) - Math.Floor(group.Width * 0.00000 + 0.5), Math.Floor(group.Height * 1.00000 + 0.5) - Math.Floor(group.Height * 0.00000 + 0.5)));
            context.SaveState();
            context.SetShadow(shadow2Offset, shadow2BlurRadius, shadow2.CGColor);
            context.RestoreState();
            context.SaveState();

...
namespace InterShareMobile.Controls
{
    public class Pulse : SKCanvasView
    {
        ...
        private double _cycleTime = 30000; // in milliseconds
        ...
        public static readonly BindableProperty PulseColorProperty = BindableProperty.Create(nameof(PulseColor), typeof(Color), typeof(Pulse), Color.Red, propertyChanged: OnPropertyChanged);
        public static readonly BindableProperty AutoStartProperty = BindableProperty.Create(nameof(AutoStart), typeof(bool), typeof(Pulse), false, propertyChanged: OnPropertyChanged);
        public static readonly BindableProperty SourceProperty = BindableProperty.Create(nameof(Source), typeof(string), typeof(Pulse), "", propertyChanged: OnPropertyChanged);
        public static readonly BindableProperty SpeedProperty = BindableProperty.Create(nameof(Speed), typeof(int), typeof(Pulse), 10, propertyChanged: OnPropertyChanged);
        ...
        protected override void OnPaintSurface(SKPaintSurfaceEventArgs args)
        {
            ...
            if (IsRun)
            {
                ...
                canvas.DrawCircle(center.X, center.Y, 100, _paint);
